-- =============================================================================
-- NEUROINCLUDE — Cole este arquivo INTEIRO no Supabase: SQL Editor → New query → Run
-- Projeto deve ser o MESMO da URL em VITE_SUPABASE_URL no seu .env
-- Depois: Table Editor → confira tabelas "alunos" e "materiais" em public
-- =============================================================================
